...
func ToFilterParamsOptional(q ethereum.FilterQuery) (interface{}, error) {
	//0-latest
	//-1-pending
	//-2-earliest
	arg := map[string]interface{}{}
...
func SendMsg(host string, msg *JsonRpcMessage) (*http.Response, error) {
...
func SendBatchMsg(host string, msg []*JsonRpcMessage) (*http.Response, error) {
	body, err := json.Marshal(msg)
	if err != nil {
		return nil, err
	}
